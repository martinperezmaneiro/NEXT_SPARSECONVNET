...
if __name__ == "__main__":
    ...
    filein = os.path.expandvars(config.orig_file)
    fileout = os.path.expandvars(config.pred_file)
    ...
    for th in threshold:
        for dis in distances:
            ...
            start_time = time()
            eventInfo_pred = segmentation_blob_classification(filein, fileout, th, nevents = nevents, max_distance = dis)
